#include <stdint.h>
#include "../headers/weights_mlp_8b.h"
...
void mlp_accel_8b(const data_t in_vec[INPUT_NODES], data_t out_vec[OUTPUT_NODES]) {
    ...
    #pragma HLS ARRAY_PARTITION variable=weights_l1_8b complete dim=3
    #pragma HLS ARRAY_PARTITION variable=weights_l2_8b complete dim=3
    #pragma HLS ARRAY_PARTITION variable=weights_l3_8b complete dim=3
