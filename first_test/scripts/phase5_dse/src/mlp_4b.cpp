#include <stdint.h>
#include "../headers/weights_mlp_4b.h"
...
#define RESCALE_SHIFT 2
#define RESCALE_ROUND 2
...
inline acc_t simd_mac16(const data_t act[SIMD_WIDTH], const weight_t w[SIMD_WIDTH]) {
    #pragma HLS INLINE
...
void mlp_accel_4b(const data_t in_vec[INPUT_NODES], data_t out_vec[OUTPUT_NODES]) {
    ...
    #pragma HLS ARRAY_PARTITION variable=weights_l1_4b complete dim=3
    #pragma HLS ARRAY_PARTITION variable=weights_l2_4b complete dim=3
    #pragma HLS ARRAY_PARTITION variable=weights_l3_4b complete dim=3
